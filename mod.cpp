name			= "Advanced Vanilla Objects v0.0.0";	// Name of your mod
...
tooltip			= "Advanced Vanilla Objects";
tooltipOwned	= "Advanced Vanilla Objects";			// Tool tip displayed when the mouse is left over, in the main menu
picture			= "img\icon_ca.paa";			// Picture displayed from the expansions menu. Optimal size is 2048x1024
actionName		= "GitHub";
action			= "https://github.com/Andx667/advanced_vanilla_objects";	// Website URL, that can be accessed from the expansions menu
